<?php $__env->startSection('title', 'Crypto Dashboard'); ?>
                        ...
                        <div class="card crypto-main-card">
                            <div class="card-body">
                                <div class="deposit-wrap">
                                    ...
                                    </div><img src="<?php echo e(asset('assets/images/dashboard-4/crypto.png')); ?>" alt="crypto">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="currency-widget warning">
                            <div class="d-flex">
                                <div class="currency-icon-widget"> <svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#beta')); ?>"></use>
                                    </svg></div>
                                <div>
                    ...
                    <div class="col-sm-4">
                        <div class="currency-widget primary">
                            <div class="d-flex">
                                <div class="currency-icon-widget"> <svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#eth')); ?>"></use>
                                    </svg></div>
                                <div>
                    ...
                    <div class="col-sm-4">
                        <div class="currency-widget success">
                            <div class="d-flex">
                                <div class="currency-icon-widget"> <svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#ltc')); ?>"></use>
                                    </svg></div>
                                <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon warning"><svg>
                                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#beta')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon success"><svg>
                                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#ltc')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon primary"><svg>
                                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#eth')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon secondary"><svg>
                                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#bin')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon dark-green"><svg>
                                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#te')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon dark-green"><svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#chainlink')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon primary"><svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#solana')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="currency-icon primary"><svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#cardano')); ?>">
                                                                </use>
                                                            </svg></div>
                                                        <div>
                        ...
                        <div class="card balance-box">
                            <div class="card-body">
                                <div class="balance-profile">
                                    <div class="balance-img"><img src="<?php echo e(asset('assets/images/dashboard-4/user.png')); ?>"
                                            alt="user vector"><a class="edit-icon" href="<?php echo e(route('admin.user_profile')); ?>"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#pencil')); ?>"></use>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="currency-icon warning"><svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#beta')); ?>">
                                                                    </use>
                                                                </svg></div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="currency-icon success"><svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#ltc')); ?>">
                                                                    </use>
                                                                </svg></div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="currency-icon primary"><svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#eth')); ?>">
                                                                    </use>
                                                                </svg></div>
                                                            <div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="currency-icon light-blue"><svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#dash')); ?>">
                                                                    </use>
                                                                </svg></div>
                                                            <div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Anna K.</a><span class="f-light">To :
                                                        07...12bb</span></td>
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle me-2"
                                                        ...
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Guy H.</a><span class="f-light">To :
                                                        09...12ac</span></td>
                                                <td class="text-end"> <span class="font-success">+0.3BNB</span><span
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle me-2"
                                                        ...
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Jenny W.</a><span class="f-light">To :
                                                        01...12ab</span></td>
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle me-2"
                                                        ...
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Jacob B.</a><span class="f-light">To :
                                                        01...12nf</span></td>
                                                <td class="text-end"> <span class="font-success">+0.3BNB</span><span
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle me-2"
                                                        ...
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Esther H.</a><span class="f-light">To :
                                                        07...12bd</span></td>
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle me-2"
                                                        ...
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="<?php echo e(route('admin.user_profile')); ?>">Leslie A.</a><span class="f-light">To :
                                                        03...12se</span></td>
                                                <td class="text-end"> <span class="font-success">+0.3BNB</span><span
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-secondary"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#bin')); ?>"></use>
                                                    </svg></div>
                                                <div>
                                                    <h6 class="f-14 mb-0 f-w-400">Binance</h6>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-warning"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#te1')); ?>"></use>
                                                    </svg></div>
                                                <div>
                                                    <h6 class="f-14 mb-0 f-w-400">Tether</h6>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-success"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#dash')); ?>">
                                                        </use>
                                                    </svg></div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-primary"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#cardano')); ?>">
                                                        </use>
                                                    </svg></div>
                                                <div>
                                                    <h6 class="f-14 mb-0 f-w-400">Cardano</h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-secondary"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#solana')); ?>">
                                                        </use>
                                                    </svg></div>
                                                <div>
                                                    <h6 class="f-14 mb-0 f-w-400">Solana</h6>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon bg-success"><svg>
                                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#ripple')); ?>">
                                                        </use>
                                                    </svg></div>
                                                <div>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\cost-cue\resources\views/dashboards/crypto_dashboard.blade.php ENDPATH**/ ?>