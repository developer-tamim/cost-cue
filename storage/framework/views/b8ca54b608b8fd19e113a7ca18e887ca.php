        ...
        <div class="row widget-grid">
            <div class="col-xxl-4 col-sm-6 box-col-6">
                <div class="card profile-box">
                    <div class="card-body">
                        <div class="d-flex media-wrapper justify-content-between">
                            <div class="flex-grow-1">
                                <div class="greeting-user">
                                    <h2 class="f-w-600">Welcome <?php echo e(\Illuminate\Support\Str::title(auth()->user()->first_name ?? '')); ?> <?php echo e(\Illuminate\Support\Str::title(auth()->user()->last_name ?? '')); ?>!</h2>
                                    <p>Here whats happing in your account today</p>
                                    <div class="whatsnew-btn"><a class="btn btn-outline-white" href="<?php echo e(route('admin.user_profile')); ?>"
                        ...
                        <div class="cartoon"><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard/cartoon.svg')); ?>"
                                ...
                                <div class="widget-content">
                                    <div class="widget-round secondary">
                                        <div class="bg-round"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#c-revenue')); ?>"> </use>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round success">
                                            <div class="bg-round"><svg>
                                                    <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#c-customer')); ?>">
                                                    </use>
                                                </svg><svg class="half-circle svg-fill">
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round warning">
                                        <div class="bg-round"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#c-profit')); ?>"> </use>
                                            </svg><svg class="half-circle svg-fill">
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#halfcircle')); ?>"></use>
                                            </svg></div>
                                    </div>
                            ...
                            <table class="table" id="top-customer">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                ...
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Jane Cooper</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Wade Warren</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    src="<?php echo e(asset('assets/images/dashboard/user/4.jpg')); ?>"
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Guy Hawkins</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Jake Spy</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Devin Jake</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Jacob Jones</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Jams Bone</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                    ...
                                                    alt="user">
                                                <div class="img-content-box"><a class="f-w-500"
                                                        href="<?php echo e(route('admin.list_products')); ?>">Mili Pais</a>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    ...
                                    <ul class="common-flex pb-1">
                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard/bg-1.png')); ?>"
                                                alt="background"></li>
                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard/bg-2.png')); ?>"
                                                alt="background"></li>
                                        <li><img class="img-fluid" src="<?php echo e(asset('assets/images/dashboard/bg-3.png')); ?>"
                                                alt="background"></li>
                                    </ul>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Bag</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#452140 </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>Jenny Wilson</td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Sofa</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#844967</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>Esther Howard</td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Lamp</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#321489</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Watch</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#954687</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Football</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#896748</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>Darrell Steward</td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">T-shirt</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#321489</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Sleeper</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#452140 </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="currency-icon warning"><img class="img-fluid"
                                                        ...
                                                        alt=""></div>
                                                <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                        href="<?php echo e(route('admin.products_details')); ?>">Shoes</a>
                                                    <p class="c-o-light" href="<?php echo e(route('admin.checkout')); ?>">#844967</p>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 box-col-4 ord-xl-7 ord-md-2 box-ord-7">
                <div class="card buy-card"><img class="img-fluid"
                        src="<?php echo e(asset('assets/images/dashboard/purchase1.png')); ?>" alt="vector mens with laptop">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DevTeam\Downloads\Telegram Desktop\cuba_v11.1_3\laravel\laravel\cuba-laravel\cuba-laravel\resources\views/dashboards/index.blade.php ENDPATH**/ ?>