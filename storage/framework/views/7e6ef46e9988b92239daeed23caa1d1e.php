            ...
            <div class="header-wrapper row m-0">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper"><a href="<?php echo e(route('admin.default_dashboard')); ?>"><img class="img-fluid for-light"
                                src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt=""><img
                ...
                <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
                    <div class="notification-slider">
                        <div class="d-flex h-100"> <img src="<?php echo e(asset('assets/images/giftools.gif')); ?>" alt="gif">
                    ...
                    <ul class="nav-menus">
                                ...
                                <ul>
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                src="<?php echo e(asset('assets/images/other-images/cart-img.jpg')); ?>"
                                                alt="">
                                    ...
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                src="<?php echo e(asset('assets/images/other-images/cart-img1.jpg')); ?>"
                                                alt="">
                                    ...
                                    <li class="text-center"><a class="d-block view-cart f-w-700 btn btn-primary w-100"
                                            href="<?php echo e(route('admin.cart')); ?>">View Cart</a><a
                                            class="btn btn-primary view-checkout btn btn-primary w-100 f-w-700"
                                            href="<?php echo e(route('admin.checkout')); ?>">Checkout</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 py-0">
                            <div class="d-flex profile-media"><img class="b-r-10"
                                ...
                                <div class="flex-grow-1"><span><?php echo e(ucfirst(auth()?->user()?->first_name)); ?></span>
                                    <p class="mb-0"><?php echo e(auth()?->user()->role->name); ?> <i class="middle fa-solid fa-angle-down"></i></p>
                                </div>
                            </div>
                            <ul class="profile-dropdown onhover-show-div">
                                <li><a href="<?php echo e(route('admin.user.edit-profile',auth()->user()->role->name)); ?>"><i data-feather="user"></i><span>My Profile </span></a></li>
                                <li><a href="<?php echo e(route('admin.mail_box')); ?>"><i data-feather="mail"></i><span>Inbox</span></a></li>
                                <li><a href="<?php echo e(route('admin.task')); ?>"><i data-feather="file-text"></i><span>Taskboard</span></a>
                                </li>
                                <li><a href="<?php echo e(route('admin.add_user')); ?>"><i data-feather="settings"></i><span>Settings</span></a>
                                </li>
                                <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i data-feather="log-in"> </i><span>Log out</span></a></li>
...
<div class="ProfileCard-realName">name</div>
        ...
        <!-- Page Header Ends -->
<?php /**PATH C:\Users\DevTeam\Downloads\Telegram Desktop\cuba_v11.1_3\laravel\laravel\cuba-laravel\cuba-laravel\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>