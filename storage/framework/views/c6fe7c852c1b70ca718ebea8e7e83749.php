                    ...
                    <div class="card-body">
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" id="overview-project-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use xlink:href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-search')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                            ...
                            <li class="nav-item"> <a class="nav-link" id="target-project-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-target')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                    <div class="product-tab-content">
                            ...
                            <li class="nav-item"> <a class="nav-link" id="budget-project-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-badget')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                    <div class="product-tab-content">
                            ...
                            <li class="nav-item"><a class="nav-link" id="team-project-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-users')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                    <div class="product-tab-content">
                            ...
                            <li class="nav-item"><a class="nav-link" id="attachment-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-files')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                    <div class="product-tab-content">
                            ...
                            <li class="nav-item"><a class="nav-link" id="activity-project-tab" data-bs-toggle="pill"
                                    ...
                                    <div class="nav-rounded">
                                        <div class="product-icons"><svg>
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-activity')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                    <div class="product-tab-content">
                                    ...
                                    <div class="customers">
                                        <ul>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard/user/10.jpg')); ?>"
                                                    alt="user">
                                            </li>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/dashboard/user/11.jpg')); ?>"
                                                    alt="user">
                                            </li>
                            ...
                            <div class="common-align">
                                <ul class="common-align">
                                    <li><span>Create Date &colon;</span><svg>
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#vector-calendar')); ?>"></use>
                                        </svg><span>10 Jul, 2024 </span></li>
                                    <li> <span>Due Date &colon;</span><svg>
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#vector-calendar')); ?>"></use>
                                        </svg><span>10 Aug, 2024</span></li>
                                </ul><a class="btn btn-primary" href="<?php echo e(route('admin.create_project')); ?>" target="_blank"><i
                                            ...
                                            <div class="card-header card-no-border">
                                                <div class="common-space">
                                                    ...
                                                    <div class="card-header-right-btn"><a class="c-o-light"
                                                            href="<?php echo e(route('admin.list_products')); ?>">View All</a></div>
                                                </div>
                                            </div>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div class="attachment-file common-flex">
                                                                            <div class="common-flex align-items-center">
                                                                                <img class="img-fluid"
                                                                                    src="<?php echo e(asset('assets/images/project/files/pdf.png')); ?>"
                                                                                    alt="pdf">
                                                                                <div class="d-block">
                                                                                ...
                                                                                href="<?php echo e(asset('assets/pug/pages/template/text_file.pdf')); ?>"
                                                                                download> <i
                                        ...
                                        <div class="card">
                                            <div class="card-header card-no-border">
                                                <div class="common-space">
                                                    ...
                                                    <div class="card-header-right-btn"><a class="c-o-light"
                                                            href="<?php echo e(route('admin.to_do')); ?>">View All</a></div>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-9/user/1.png')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-9/user/2.png')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-9/user/3.png')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-9/user/4.png')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-9/user/5.png')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/1.jpg')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/9.jpg')); ?>"
                                                                            alt="user">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="common-flex align-items-center">
                                                                        <img class="img-fluid lead-img"
                                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/11.jpg')); ?>"
                                                                            alt="user">
                                        ...
                                        <div class="card">
                                            <div class="card-header card-no-border">
                                                <div class="common-space">
                                                    ...
                                                    <div class="card-header-right-btn"><a class="c-o-light"
                                                            href="<?php echo e(route('admin.task')); ?>">View All</a></div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0">
                                                            ...
                                                            <li class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-shrink-0">
                                                                    <p class="mb-0">10 min ago</p><svg
                                                                        class="fill-icon">
                                                                        <use
                                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#clock')); ?>">
                                                                        </use>
                                                                    </svg><span>02:00</span>
                                                                </div>
                                                            </li>
                                        ...
                                        <div class="card">
                                            <div class="card-header card-no-border">
                                                <div class="common-space">
                                                    ...
                                                    <div class="card-header-right-btn"><a class="c-o-light"
                                                            href="<?php echo e(route('admin.chat_private')); ?>">View All</a></div>
                                                </div>
                                            </div>
                                                ...
                                                <ul>
                                                    <li class="common-align gap-2">
                                                        <div class="flex-shrink-0"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard-11/user/7.jpg')); ?>"
                                                                alt="user"></div>
                                                        <div class="flex-grow-1">
                                                        ...
                                                        <div class="d-flex"> <svg data-bs-toggle="tooltip"
                                                                ...
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#view-member')); ?>">
                                                                </use>
                                                            </svg><svg data-bs-toggle="tooltip" data-bs-placement="top"
                                                                data-bs-title="Chat">
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-note')); ?>">
                                                                </use>
                                                            </svg></div>
                                                    </li>
                                                    <li class="common-align gap-2">
                                                        <div class="flex-shrink-0"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard-11/user/4.jpg')); ?>"
                                                                alt="user"></div>
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <li class="common-align gap-2">
                                                        <div class="flex-shrink-0"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard-11/user/12.jpg')); ?>"
                                                                alt="user"></div>
                                                        <div class="flex-grow-1">
                                        ...
                                        <div class="card">
                                            <div class="card-header card-no-border">
                                                <div class="common-space">
                                                    ...
                                                    <div class="card-header-right-btn"><a class="c-o-light"
                                                            href="<?php echo e(route('admin.course_details')); ?>">View All</a></div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0">
                                                <ul class="user-comment-wrapper">
                                                    <li class="common-align gap-2 align-items-start">
                                                        <div class="flex-shrink-0"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard/user/13.jpg')); ?>"
                                                                alt="user"></div>
                                                        <div class="flex-grow-1">
                                                            <div class="common-space pb-1">
                                                                <h6>Caleb Rivera</h6><button class="btn c-o-light"><svg
                                                                        class="me-2">
                                                                        <use
                                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#stroke-arrow')); ?>">
                                                                        </use>
                                                                    </svg>Reply</button>
                                                    ...
                                                    <li class="common-align gap-2 align-items-start">
                                                        <div class="flex-shrink-0"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/dashboard/user/12.jpg')); ?>"
                                                                alt="user"></div>
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="progress-project-box">
                                                    <div class="list-box title-line-warning">
                                                        ...
                                                        <div class="project-body"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/project/objective/phone1.png')); ?>"
                                                                alt="phone">
                                                            ...
                                                            <ul class="common-f-start">
                                                                <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-title="Marley Ford"><img
                                                                        ...
                                                                        src="<?php echo e(asset('assets/images/dashboard-11/user/10.jpg')); ?>"
                                                                        alt="user"></li>
                                                                <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            <div class="project-bottom common-space">
                                                                <div class="common-flex"><span data-bs-toggle="tooltip"
                                                                        ...
                                                                        data-bs-title="Attachment"><svg class="me-2">
                                                                            <use
                                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-attachment')); ?>">
                                                                            </use>
                                                                        </svg>7</span><span data-bs-toggle="tooltip"
                                                                        data-bs-placement="top"
                                                                        data-bs-title="Comments"><svg class="me-2">
                                                                            <use
                                                                                href="<?php echo e(asset('assets/svg/icon-sprite.svg#project-cmt')); ?>">
                                                                            </use>
                                                                        </svg>5</span></div>
                                                                <p class="mb-0 c-o-light"> <svg class="me-2">
                                                                        <use
                                                                            href="<?php echo e(asset('assets/svg/icon-sprite.svg#vector-calendar')); ?>">
                                                                        </use>
                                                                    </svg>02 Jul, 2024</p>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <ul class="common-f-start">
                                                                <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-title="Sarah Wilson"><img
                                                                        class="rounded-circle"
                                                                        src="<?php echo e(asset('assets/images/dashboard-11/user/2.jpg')); ?>"
                                                                        alt="user"></li>
                                                                <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                                ...
                                                                <li data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-title="Jessica Anderson"><img
                                                                        class="rounded-circle"
                                                                        src="<?php echo e(asset('assets/images/dashboard-11/user/8.jpg')); ?>"
                                                                        alt="user"></li>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="progress-project-box">
                                                    <div class="list-box title-line-warning">
                                                        ...
                                                        <div class="project-body"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/project/objective/phone.png')); ?>"
                                                                alt="phone">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="progress-project-box">
                                                    <div class="list-box title-line-warning">
                                                        ...
                                                        <div class="project-body"><img class="img-fluid"
                                                                src="<?php echo e(asset('assets/images/project/objective/phone2.png')); ?>"
                                                                alt="phone">
                                    ...
                                    <div class="card-body">
                                        <div class="main-team-box">
                                            ...
                                            <div>
                                                <div class="team-box">
                                                    <div class="team-box-circle"><img class="img-fluid rounded-circle"
                                                            src="<?php echo e(asset('assets/images/dashboard-11/user/3.jpg')); ?>"
                                                            alt="user"></div>
                                                    <div class="team-box-content">
                                                ...
                                                <div class="common-f-start">
                                                    <div class="bg-10-primary">
                                                        <div class="outer-file-circle shadow-10-primary">
                                                            <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#attach-img')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                    ...
                                                    <div class="bg-10-secondary">
                                                        <div class="outer-file-circle shadow-10-secondary">
                                                            <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#attach-audio')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                    ...
                                                    <div class="bg-10-success">
                                                        <div class="outer-file-circle shadow-10-success">
                                                            <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#attach-video')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                    ...
                                                    <div class="bg-10-warning">
                                                        <div class="outer-file-circle shadow-10-warning">
                                                            <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#attach-doc')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                    ...
                                                    <div class="bg-10-primary">
                                                        <div class="outer-file-circle shadow-10-primary">
                                                            <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#attach-pdf')); ?>">
                                                                </use>
                                                            </svg>
                                                        </div>
                                                ...
                                                <div class="upload-files-wrapper">
                                                    <div class="create-file-box">
                                                        <div class="d-flex"> <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#vector-create')); ?>">
                                                                </use>
                                                            </svg>
                                                            <div>
                                                                <h6>Create Folder</h6>
                                                    ...
                                                    <div class="upload-file-box">
                                                        <div class="d-flex"> <svg>
                                                                <use
                                                                    href="<?php echo e(asset('assets/svg/icon-sprite.svg#vector-upload')); ?>">
                                                                </use>
                                                            </svg>
                                                            <div>
                                                                <h6>Upload files </h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#doc-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>Logger...</h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#ai-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>User Product</h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#sql-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>Database Log..</h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#pdf-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>Dashboard Doc</h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#xml-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>React Theme...</h6>
                                                    ...
                                                    <div><a href="<?php echo e(route('admin.file_manager')); ?>">
                                                            <div class="d-flex"> <svg>
                                                                    <use
                                                                        href="<?php echo e(asset('assets/svg/icon-sprite.svg#css-file')); ?>">
                                                                    </use>
                                                                </svg>
                                                                <div>
                                                                    <h6>Mofi Theme..</h6>
                                                        ...
                                                        <div class="w-100 ms-3">
                                                            <h6 class="f-w-400">New order<a
                                                                ...
                                                                by<span class="activity-profile"><img class="img-fluid"
                                                                        src="<?php echo e(asset('assets/images/user/common-user/3.png')); ?>"
                                                                        alt="user"><span>Mili
                                                                        Pais</span></span></span>
                                                        ...
                                                        <div class="w-100 ms-3">
                                                            <h6 class="f-w-400">Megan Elmore</h6><span
                                                                ...
                                                                attachments - 03:45 PM<span class="activity-profile"><img
                                                                        class="img-fluid"
                                                                        src="<?php echo e(asset('assets/images/user/common-user/5.png')); ?>"
                                                        ...
                                                        <div class="w-100 ms-3">
                                                            <h6 class="f-w-400">Five new flowchart ideas
                                                                ...
                                                                4:23 PM by<span class="activity-profile"><img
                                                                        class="img-fluid"
                                                                        src="<?php echo e(asset('assets/images/user/common-user/7.png')); ?>"
                                                                ...
                                                                <div class="flowchart-wrapper">
                                                                    <div>
                                                                        <div class="flowchart-img"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/project/flowchart-1.png')); ?>"
                                                                                alt="flowchart"></div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="flowchart-img"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/project/flowchart-2.png')); ?>"
                                                                                alt="flowchart"></div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="flowchart-img"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/project/flowchart-3.png')); ?>"
                                                                                alt="flowchart"></div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="flowchart-img"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/project/flowchart-4.png')); ?>"
                                                                                alt="flowchart"></div>
                                                                    </div>
                                                                    <div>
                                                                        <div class="flowchart-img"><img
                                                                                class="img-fluid"
                                                                                src="<?php echo e(asset('assets/images/project/flowchart-5.png')); ?>"
                                                                                alt="flowchart"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <h6 class="f-w-400">Any kind of collaborative
                                                                ...
                                                                understand it and contribute to the project.
                                                                    ...
                                                                    class="activity-profile"><img class="img-fluid"
                                                                        src="<?php echo e(asset('assets/images/user/common-user/1.png')); ?>"
                                                                        alt="user"><span>Guy
                                                    ...
                                                    <li class="d-flex">
                                                        ...
                                                        <div class="w-100 ms-3">
                                                            ...
                                                            <span class="date-time">At 8:05 PM by<span
                                                                    class="activity-profile"><img class="img-fluid"
                                                                        src="<?php echo e(asset('assets/images/user/common-user/8.png')); ?>"
                                                                        alt="user"><span>Jacob
                                                                    ...
                                                                    <table class="table project-task-note">
                                                                        ...
                                                                        <tbody class="project-content">
                                                                            <tr>
                                                                                ...
                                                                                <td>14 Oct, 2024</td>
                                                                                <td><a class="btn"
                                                                                        href="<?php echo e(route('admin.list_products')); ?>">View</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/custom-project.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/tooltip-init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\cost-cue\resources\views/projects/details_project.blade.php ENDPATH**/ ?>